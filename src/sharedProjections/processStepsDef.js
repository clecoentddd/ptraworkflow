// Process steps definition for workflow UIs
// Usage: import processStepsDef from './processStepsDef';

const processStepsDef = [
  { id: 1, name: 'Créer la mutation' },
  { id: 2, name: 'Suspendre les paiements' },
